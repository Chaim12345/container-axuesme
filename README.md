...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-axuesme.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-axuesme.containers.anotherwebservice.com/
...
```
git clone git@github.com:Chaim12345/container-axuesme.git
cd container-axuesme
```
...
```
docker attach container-axuesme
```
